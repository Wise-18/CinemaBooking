	...
	return (
		<div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-indigo-900 to-blue-500 py-12 px-4 sm:px-6 lg:px-8">
			<div className="w-full max-w-md space-y-8 rounded-2xl bg-white p-4 shadow-xl">
				...
				<div className="mt-8">
					<h3 className="text-center text-lg font-semibold">Or login with:</h3>
					<div className="flex flex-col gap-4 mt-4">
						<a href="http://localhost:8080/auth/google">
							<button className="w-full rounded-md bg-red-500 py-2 px-4 font-medium text-white hover:bg-red-600">
								Login with Google
							</button>
						</a>
						<a href="http://localhost:8080/auth/facebook">
							<button className="w-full rounded-md bg-blue-800 py-2 px-4 font-medium text-white hover:bg-blue-900">
								Login with Facebook
							</button>
						</a>
					</div>
